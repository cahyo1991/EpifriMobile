...
const _Nama = this.state.Nama;
const _Email = this.state.Email;
const _Password = this.state.Password;
 const  Url = global.Api + 'User/createAccount/?Username='+_Email+'&&Password='+_Password+'&&Email='+_Email+'&&FirstName=' +_Nama+'&&LastName=-&&DOB=-&&Type=1';
       ...
       if (Status == "True"){
         ...
         setTimeout(()=>{
          this.setState({
            ...
            setTimeout(()=>{
              this.props.navigation.navigate('OtpScreen',{Email : this.state.Email});
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        <Text style={{fontSize : 27,fontWeight:'bold',textAlign:'center',marginTop:20,color:'#662d91'}}>BUAT AKUN</Text>
            {/* input dan label */}
            <Text style={{fontSize : 23,marginTop:20,color:'#662d91'}}>Nama * 
...
/>
            ...
            {/* input dan label */}
                        ...
                        <Text style={{fontSize : 23,marginTop:20,color:'#662d91'}}>Email *
...
/>
            ...
            {/* input dan label */}
                        ...
                        {/* input dan label */}
                        <Text style={{fontSize : 23,marginTop:20,color:'#662d91'}}>Password *</Text>
            <View style={{backgroundColor:'#f2f2f4',height:60,marginTop:5}}>
            <Input
            style={{paddingTop:15}}
              inputContainerStyle={{borderBottomWidth:0}}
...
<LinearGradient colors={['#6857d6', '#876ae3', '#aa7ef3']} style={styles.linearGradient}>
  <TouchableOpacity onPress={() => {
    DoRegister()
    // navigate('OtpScreen',{Email : 'Tester Email'})
  }}>
